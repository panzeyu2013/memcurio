...
injectBudget) {
    ...
    ctx.tools.register(defineTool({
        ...
        description: "Persist a durable memory note for future sessions. Call it when the user asks you to remember, forget or update something, or when you confirm a durable preference, decision, correction or reusable lesson that a future session should inherit. Notes are append-only input for consolidation; never edit memory files directly.",
        parameters: {
