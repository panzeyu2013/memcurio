...
export function renderReadPathInstructions() {
    return [
        ...
        "",
        "Citations: after using memory and before your final answer, call memory_cite once with every",
        "memory entry you actually used (locators like `MEMORY.md:10-14` or",
        "`rollout_summaries/<file>.md:2-5`) and any rollout ids you relied on. Locators are memory entry",
