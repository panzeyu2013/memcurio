...
export const WRITE_PATH_PREFIXES = ["extract.", "adhoc.", "consolidate.", "prune.", "purge."];
...
export const NON_WRITE_EXTRACT_ACTIONS = new Set([
    "extract.noop",
    "extract.stale",
    "extract.repaired",
    "extract.requeued",
...
export function isWritePathAction(action) {
