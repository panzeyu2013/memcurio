...
var en = {
  ...
  injectContextNote: "Evaluated on every agent step, but unchanged content is never re-injected: the static context once per session, dynamic hits only when they change.",
...
var zh = {
  ...
  injectContext: "\u8BB0\u5FC6",
  injectContextNote: "\u6BCF\u4E2A agent step \u90FD\u8BC4\u4F30\uFF1B\u5185\u5BB9\u672A\u53D8\u4E0D\u91CD\u590D\u6CE8\u5165\uFF1A\u9759\u6001\u4E0A\u4E0B\u6587\u6BCF\u4F1A\u8BDD\u4E00\u6B21\uFF0C\u52A8\u6001\u547D\u4E2D\u4EC5\u5728\u53D8\u5316\u65F6\u6CE8\u5165\u3002",
...
function MemcurioGuideRow(props) {
  ...
  return (0, import_react6.createElement)(
    ...
    (0, import_react6.createElement)(
      ...
      (0, import_react6.createElement)("span", { className: "memcurio-context-sep", "aria-hidden": true }),
      (0, import_react6.createElement)("span", { className: "memcurio-context-source", "data-memcurio-guide-detail": true }, t("guideRowDetail", { chars, tools })),
      (0, import_react6.createElement)("span", { className: "memcurio-context-chevron" }, (0, import_react6.createElement)(ChevronDownIcon, {}))
    ),
    open && text !== "" ? (0, import_react6.createElement)("div", { className: "memcurio-context-body", "data-memcurio-guide-body": true }, text) : null
  );
}
